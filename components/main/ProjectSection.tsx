...
export default function ProjectSection() {
  return (
    ...
    <section
      className={`font-orbitron ${orbitron.variable} py-4 relative overflow-hidden text-white`}
    >
      {/* Sectio Title */}
              ...
              <CardHeader>
                <CardTitle>
                  <Link
                    ...
                    className="text-blue-400 flex gap-2 font-semibold hover:text-zinc-400 hover:underline"
              ...
              <Card className="w-full max-w-md mx-auto p-4 z-50">
                ...
                <CardContent>
                  <p className="text-gray-300">
                    A hub where I share my knowledge, learning journey, and
                    development experiences. It&apos;s a space for connecting with
                    others, exchanging ideas, and growing together through
                    shared insights, questions, and solutions.
                  </p>
                </CardContent>
                <CardFooter>
